...
internal class SdkCompletionContributorTest {
    ...
    fun `getDemoSdk should return correct sample code on successful response`() {
        ...
        assertEquals("// ${I18nUtils.getMsg("NO_SDK_PREFIX")} java ${I18nUtils.getMsg("NO_SDK_SUFFIX")}", demoSdkJava)
    }
    ...
    fun `getDemoSdk should handle IOException`() {
        ...
        val title = I18nUtils.getMsg("GENERATE_CODE_SAMPLE_FAIL")
        val content = I18nUtils.getMsg("CHECK_NETWORK")
